import { View, PanelHeader, Panel, Group, FormLayout } from '@vkontakte/vkui'
...
const AdminDebtors = props => {
    ...
    .then(data => setDebtors(data.data))
    .catch(error => console.error(error)), //eslint-disable-next-line
    [body]
    )
